...
sambamba markdup -t 16 -r $PROJECTDIR/mapped/${SAMPLE_NAME}.bam $PROJECTDIR/mapped/${SAMPLE_NAME}.nodups.bam
sambamba index -t 16 $PROJECTDIR/mapped/${SAMPLE_NAME}.nodups.bam
