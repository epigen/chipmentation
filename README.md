...
Code for the Schmidl 2015 'ChIPmentation' project
-----
...
All downstram analysis is performed with scripts currently in `src/scripts` using the and uses libraries such as HTSeq and pybedtools for efficiency and clarity.
